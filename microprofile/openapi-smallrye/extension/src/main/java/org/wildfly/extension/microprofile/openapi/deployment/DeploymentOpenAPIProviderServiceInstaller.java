                                ...
                                if (contextPath.length() > 1) {
                                    ...
                                    if (paths != null) {
                                        ...
                                        if ((items != null) && !items.isEmpty()) {
                                            Map<String, PathItem> contextualItems = new TreeMap<>();
                                            for (Map.Entry<String, PathItem> entry : items.entrySet()) {
                                                contextualItems.put(contextPath + entry.getKey(), entry.getValue());
                                            }
                                            paths.setPathItems(Collections.unmodifiableMap(items));
                                        }
                                    }
                                }
