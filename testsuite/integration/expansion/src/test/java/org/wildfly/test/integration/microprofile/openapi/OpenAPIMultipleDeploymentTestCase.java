        ...
        public ConfigServerSetupTask() {
            super(createContainerConfigurationBuilder()
                    .setupScript(createScriptBuilder()
                            ...
                            .add("/system-property=mp.openapi.extensions.server.default-server.host.default-host.format:add(value=%1\\$s-%2\\$s)")
                            .build())
                    .tearDownScript(createScriptBuilder()
                            ...
                            .add("/system-property=mp.openapi.extensions.server.default-server.host.default-host.format:remove")
                            .build())
                    .build());
        }
    }
